  ...
  return (
    <>
      <motion.div
        ...
        className="sm:pt-[25%] md:pt-[10%] text-darktext flex flex-col h-[100%] shadow-mainwhite shadow-lg"
      >
        <div className="flex flex-col gap-5 font-bold mx-auto">
          <h1 className="text-noto sm:text-4xl md:text-6xl font-bold">
            ギャラリ
          </h1>
          <h1 className="font-black sm:text-7xl md:text-8xl mb-3">gallery.</h1>
          <motion.p
            initial={{ opacity: 0, x: -150 }}
            animate={{
              opacity: 1,
